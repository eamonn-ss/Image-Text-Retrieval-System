...
class Network(nn.Module):
    def __init__(self, args):
        ...
        if args.embedding_type == 'BERT':
            # model_class, tokenizer_class, pretrained_weights = (ppb.BertModel, ppb.BertTokenizer, 'E:\\TIPCB-main\\bert-base-chinese')
            # self.text_embed = model_class.from_pretrained(pretrained_weights)
            self.text_embed = AutoModel.from_pretrained("bert-base-chinese")
            # self.text_embed = BertModel.from_pretrained('E:\\TIPCB-main\\bert-base-chinese')
